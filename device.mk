...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/angler/idc/uinput-fpc.kl:$(TARGET_COPY_OUT_SYSTEM)/usr/keylayout/uinput-fpc.kl \
    device/huawei/angler/idc/uinput-fpc.idc:$(TARGET_COPY_OUT_SYSTEM)/usr/idc/uinput-fpc.idc \
...
# Input device files
PRODUCT_COPY_FILES += \
    device/huawei/angler/idc/gpio-keys.kl:$(TARGET_COPY_OUT_SYSTEM)/usr/keylayout/gpio-keys.kl \
...
# GPS configuration
PRODUCT_COPY_FILES += \
    device/huawei/angler/gps/gps.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/gps.conf:qcom
